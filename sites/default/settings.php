 ...
 *
 */
$drupal_hash_salt = 'WgxjGMz7CdH3j3RvQnDoKJjRras1SN0hjQjUr8m2E3M';
...
if (isset($_SERVER['PANTHEON_ENVIRONMENT']) && $_SERVER['PANTHEON_ENVIRONMENT'] === 'live') {
  if ($_SERVER['HTTP_HOST'] == 'attacktheatre.com' || !isset($_SERVER['HTTP_X_SSL']) || $_SERVER['HTTP_X_SSL'] != 'ON' ) {
    header('HTTP/1.1 301 Moved Permanently');
    header('Location: https://www.attacktheatre.com'. $_SERVER['REQUEST_URI']);
    exit;
  }
}
